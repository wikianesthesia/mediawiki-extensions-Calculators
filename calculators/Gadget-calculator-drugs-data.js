...
( function() {
    ...
    mw.calculators.addDrugPopulations( {
        ...
        generalGe70kg: {
            name: 'General (&GreaterEqual;70 kg)',
            variables: {
                weight: {
                    min: '70 kgwt'
                }
        ...
        adultGe120kg: {
            name: 'Adult (&GreaterEqual;120 kg)',
            variables: {
                weight: {
                    min: '120 kgwt'
                }
        ...
        neonatalGe1200g: {
            name: 'Neonatal (&GreaterEqual;1200 g)',
            variables: {
                age: {
                    max: '0 yo'
                }
        ...
        pediatricGt9moLe40kg: {
            name: 'Pediatric (&gt;9 mo,&leq;40 kg)',
            abbreviation: 'Peds (&gt;9 mo,&leq;40 kg)',
            variables: {
                age: {
                    min: '9.1 mo'
                },
        ...
        pediatricGt40kg: {
            name: 'Pediatric (&GreaterEqual;40 kg)',
            abbreviation: 'Peds (&GreaterEqual;40 kg)',
            variables: {
                age: {
                    max: '17.9 yo'
                }
        ...
        pediatricGe120kg: {
            name: 'Pediatric (&GreaterEqual;120 kg)',
            abbreviation: 'Peds (&GreaterEqual;120 kg)',
            variables: {
                age: {
                    max: '17.9 yo'
                },
        ...
        pediatricGe2yo: {
            name: 'Pediatric (&GreaterEqual;2 yo)',
            abbreviation: 'Peds (&GreaterEqual;2 yo)',
            variables: {
                age: {
                    min: '2 yo'
                }
            ...
            dosages: [
                {
                    ...
                    population: 'adult',
                    description: 'Max 4 g/day. Use caution in hepatic impairment.',
                    dose: {
                        dose: '1 g'
                    }
                }, {
    ...
    mw.calculators.addCalculations( {
        gentamicinDosingWeight: {
            name: 'Gentamicin dosing weight',
            abbreviation: 'Gentamicin wt',
            data: {
                calculations: {
                    required: [ 'ibw' ]
                },
